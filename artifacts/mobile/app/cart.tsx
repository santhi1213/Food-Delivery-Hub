...
//                 >
//                   <Ionicons name={quantity === 1 ? "trash-outline" : "remove"} size={15} color="#fff" />
//                 </TouchableOpacity>
...
//                 </TouchableOpacity>
//               </View>
//               <Text style={[styles.itemPrice, { color: colors.foreground }]}>₹{item?.price * quantity}</Text>
//             </View>
//           ))}
//         </View>
...
//           {appliedDiscount > 0 ? (
//             <View style={[styles.appliedCoupon, { backgroundColor: colors.successBg }]}>
...
//   restaurantHeader: { flexDirection: "row", alignItems: "center", gap: 8, paddingBottom: 4 },
//   restaurantName: { fontSize: 15, fontFamily: "Inter_600SemiBold" },
//   cartItem: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 12, borderBottomWidth: StyleSheet.hairlineWidth },
//   vegDot: { width: 14, height: 14, borderWidth: 1.5, borderRadius: 2, justifyContent: "center", alignItems: "center", flexShrink: 0 },
//   vegFill: { width: 6, height: 6, borderRadius: 3 },
//   itemName: { flex: 1, fontSize: 14, fontFamily: "Inter_500Medium" },
//   qtyControl: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 8, paddingVertical: 5, borderRadius: 8 },
//   qtyText: { color: "#fff", fontSize: 13, fontFamily: "Inter_700Bold", minWidth: 14, textAlign: "center" },
//   itemPrice: { fontSize: 14, fontFamily: "Inter_600SemiBold", minWidth: 50, textAlign: "right" },
//   sectionTitle: { fontSize: 16, fontFamily: "Inter_600SemiBold" },
//   appliedCoupon: { flexDirection: "row", alignItems: "center", gap: 10, padding: 12, borderRadius: 10 },
//   couponCode: { flex: 1, fontSize: 14, fontFamily: "Inter_600SemiBold" },
//   couponRow: { flexDirection: "row", gap: 8 },
//   couponInput: { flex: 1, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 12, paddingVertical: 11, borderRadius: 10, borderWidth: 1 },
//   couponText: { flex: 1, fontSize: 14, fontFamily: "Inter_400Regular", padding: 0 },
//   applyBtn: { paddingHorizontal: 16, paddingVertical: 11, borderRadius: 10 },
//   applyText: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
//   couponError: { fontSize: 12, fontFamily: "Inter_400Regular" },
//   billRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
//   billLabel: { fontSize: 14, fontFamily: "Inter_400Regular" },
//   billValue: { fontSize: 14, fontFamily: "Inter_500Medium" },
...
//   footer: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingTop: 12, gap: 16, borderTopWidth: StyleSheet.hairlineWidth },
//   footerInfo: {},
//   footerTotal: { fontSize: 20, fontFamily: "Inter_700Bold" },
//   footerLabel: { fontSize: 12, fontFamily: "Inter_400Regular" },
//   checkoutBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 15, borderRadius: 14 },
//   checkoutText: { fontSize: 15, fontFamily: "Inter_700Bold" },
//   empty: { flex: 1, justifyContent: "center", alignItems: "center", gap: 12, padding: 24 },
//   emptyTitle: { fontSize: 20, fontFamily: "Inter_700Bold" },
//   emptyText: { fontSize: 14, fontFamily: "Inter_400Regular", textAlign: "center" },
//   browseBtn: { marginTop: 12, paddingHorizontal: 28, paddingVertical: 14, borderRadius: 14 },
