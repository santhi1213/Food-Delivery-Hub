...
// // const BASE = 'http://10.65.82.110:5000/api';
// // const BASE = 'http://192.168.0.104:5000/api';
...
// // Generic request function with enhanced error handling
...
//     addAddress: (data: { type: string; address: string; lat?: number; lng?: number }) =>
//       request<{ addresses: Address[] }>("/auth/addresses", {
//         method: "POST",
//         body: JSON.stringify(data),
//       }),

//     updateAddress: (addressId: string, data: Partial<Address>) =>
//       request<{ addresses: Address[] }>(`/auth/addresses/${addressId}`, {
//         method: "PUT",
//         body: JSON.stringify(data),
//       }),
...
//       request<{ addresses: Address[] }>(`/auth/addresses/${addressId}/default`, {
//         method: "PUT",
//       }),
...
//       request<{ restaurants: Restaurant[] }>(`/restaurants/cuisine/${cuisineType}`),

//     getFeatured: () =>
//       request<{ restaurants: Restaurant[] }>("/restaurants/featured"),

//     search: (query: string) =>
//       request<{ restaurants: Restaurant[] }>(`/restaurants/search?q=${encodeURIComponent(query)}`),

//     getMenu: (restaurantId: string) =>
//       request<{ menu: MenuCategory[] }>(`/restaurants/${restaurantId}/menu`),
...
//       return request<{ reviews: any[]; total: number }>(
//         `/restaurants/${restaurantId}/reviews${q.toString() ? `?${q.toString()}` : ''}`
//       );
//     },

//     addReview: (restaurantId: string, data: { rating: number; comment: string }) =>
//       request<{ review: any }>(`/restaurants/${restaurantId}/reviews`, {
//         method: "POST",
//         body: JSON.stringify(data),
//       }),

//     getCategories: () =>
//       request<{ categories: string[] }>("/restaurants/categories"),
//   },

//   orders: {
//     create: (data: {
//       restaurantId: string;
//       items: { menuItemId: string; quantity: number; customizations?: any[] }[];
//       deliveryAddress: Address;
//       paymentMethod: 'cash' | 'card' | 'upi' | 'razorpay';
//       instructions?: string;
//     }) =>
...
//     list: (params?: { status?: Order['status']; page?: number; limit?: number }) => {
//       const q = new URLSearchParams();
...
//     cancel: (id: string) =>
//       request<{ order: Order }>(`/orders/${id}/cancel`, {
//         method: "POST",
//       }),

//     track: (id: string) =>
//       request<{ status: Order['status']; location?: { lat: number; lng: number }; estimatedDelivery?: Date }>(
//         `/orders/${id}/track`
//       ),
...
//     }) =>
//       request<{ order: Order }>("/orders/verify-payment", {
//         method: "POST",
//         body: JSON.stringify(data),
//       }),

//     getInvoice: (id: string) =>
//       request<{ invoiceUrl: string }>(`/orders/${id}/invoice`),

//     reorder: (id: string) =>
//       request<{ order: Order }>(`/orders/${id}/reorder`, {
//         method: "POST",
//       }),
//   },
...
//   cart: {
//     get: () =>
//       request<{ cart: { items: any[]; total: number; subtotal: number; tax: number } }>("/cart"),

//     add: (data: { menuItemId: string; quantity: number; customizations?: any[] }) =>
//       request<{ cart: any }>("/cart/items", {
//         method: "POST",
//         body: JSON.stringify(data),
//       }),

//     update: (itemId: string, quantity: number) =>
//       request<{ cart: any }>(`/cart/items/${itemId}`, {
//         method: "PUT",
...
//       request<{ discount: number; total: number }>("/cart/coupon", {
//         method: "POST",
...
//   seed: {
//     restaurants: () =>
//       request<{ message: string }>("/seed/restaurants", {
//         method: "POST",
//       }),

//     users: () =>
//       request<{ message: string }>("/seed/users", {
//         method: "POST",
//       }),

//     orders: () =>
//       request<{ message: string }>("/seed/orders", {
//         method: "POST",
//       }),

//     all: () =>
//       request<{ message: string }>("/seed/all", {
//         method: "POST",
//       }),
//   },
...
export const api = {
  ...
  //     if (params?.page) q.set("page", params.page.toString());
  //     if (params?.limit) q.set("limit", params.limit.toString());
  //     return request<{ success: boolean; orders: Order[]; total: number }>(
  //       `/orders${q.toString() ? `?${q.toString()}` : ''}`
  //     );
  //   },

  //   get: (id: string) =>
  //     request<{ success: boolean; order: Order }>(`/orders/${id}`),

  //   cancel: (id: string) =>
  //     request<{ success: boolean; order: Order }>(`/orders/${id}/cancel`, {
  //       method: "POST",
  //     }),
  ...
  //     razorpaySignature: string;
  //   }) =>
  //     request<{ success: boolean; order: Order }>("/orders/verify-payment", {
  //       method: "POST",
  //       body: JSON.stringify(data),
  //     }),

  //   getInvoice: (id: string) =>
  //     request<{ success: boolean; invoiceUrl: string }>(`/orders/${id}/invoice`),

  //   reorder: (id: string) =>
  //     request<{ success: boolean; order: Order }>(`/orders/${id}/reorder`, {
  //       method: "POST",
  //     }),
  // },
